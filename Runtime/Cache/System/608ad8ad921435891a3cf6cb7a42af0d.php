    ...
    <div class="imCont">
        <div class="imContTop clearfix">
            ...
            <div class="topRight r">
                <a href="<?php echo U('System/Order/outputOrder');?>" class="addAccount">导出订单</a>
            </div>
        </div>
        ...
        <div class="Filter" id="Filter">
            <div class="frame">
                ...
                <div class="details clearfix">
                    <span>&nbsp;</span>
                    <form action="<?php echo U('System/Order/orderList');?>#pjax_body" id="subForm" method="get" onsubmit="return false;" method="get">
        ...
        <div class="forCondition clearfix">
            <form action="<?php echo U('System/Order/orderList');?>" method="get">
                <div class="selectbox l">
                    <dl class="select">
                        <dt>
            ...
            <div class="forMiddle">
                <table cellpadding="0" cellspacing="0" id="forTable">
                    ...
                    <?php if(is_array($data['order_list'])): foreach($data['order_list'] as $k=>$v): ?><tr class="content_li">
                            <td class="optionsThTd"><?php echo ($v["user_realname"]); echo ($v['zone_id']!=$data['zone_id'])?'<span style="color:green">('.$v['zone_name'].')</span>':'';?></td>
