...
class DiscountParentModel extends BaseModel
{
    protected $_id='discount_parent_id';
    ...
    protected $_validate = array(
        array('dname', 'checkSpecialCharacter', array('code'=>'201','msg'=>'名称不能含有特殊字符！'), 0, 'callback'),
        array('dname', '0,15', array('code'=>'202','msg'=>'名称不能大于15字符！'), 0, 'length'),
        array('remark', '0,350', array('code'=>'203','msg'=>'内容不能大于350字符！'), 0, 'length'),
    );
