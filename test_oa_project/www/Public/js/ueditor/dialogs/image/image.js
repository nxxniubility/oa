        ...
        initUploader: function () {
            ...
            // 所有文件的进度信息，key为file id
			 ...
			 // 罗玉修改
                ...
                uploader,
                actionUrl =(editor.getOpt('useOss')==1)?editor.getOpt('ossUploadPath'):editor.getActionUrl(editor.getOpt('imageActionName')),				
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                duplicate: true,
				formData:editor.getOpt('additionalParams'),
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
				if(editor.getOpt('useOss')==1)
				{
					var myDate=new Date();
                    data['key']=data['key']+ myDate.getFullYear()+(myDate.getMonth()+1)+myDate.getDate()+myDate.getHours()+myDate.getMinutes()+myDate.getSeconds()+myDate.getMilliseconds()+parseInt(Math.random()*10000)+'.'+file['file']['ext'] ; '${filename}';
                    file['file']['save_name']=data['key'];
				}
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
					...
					if( ret._raw==''&&editor.getOpt('useOss')==1)
					{
						json={
							state: 'SUCCESS',
							url:editor.getOpt('ossImageBaseUrl')+'/'+file['save_name'],
							title: file['save_name'],
							original: file['name'],
							type:  file['type'],
							size: file['size']
						}
